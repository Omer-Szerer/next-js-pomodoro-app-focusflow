...
//     // Show prompt only if starting a new Short Break session (initial 05:00)
//     if (
...
//     setIsRunning(true); // Start the timer after selecting a break type
//   };
...
//       {showBreakPrompt && <div className={styles.fullPageBlur}></div>}
